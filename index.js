...
const makeCommits = async (n, year, month, day) => {
  ...
  console.log(`Commit ${16 - n} made with date ${year}-${month}-${day}`); // Show commit number and date
...
makeCommits(15, 2025, 2, 12); // Example: making commits with the date Jan 1, 2024
