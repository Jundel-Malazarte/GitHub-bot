...
const makeCommits = async (n, year, month, day) => {
  ...
  console.log(`Commit ${10 - n} made with date ${year}-${month}-${day}`); // Show commit number and date
...
makeCommits(21, 2025, 3, 31); // Example: making commits with the date Jan 1, 2024