...
const makeCommits = async (n, year, month, day) => {
  ...
  console.log(`Commit ${14 - n} made with date ${year}-${month}-${day}`); // Show commit number and date
...
makeCommits(13, 2025, 3, 5); // Example: making commits with the date Jan 1, 2024
