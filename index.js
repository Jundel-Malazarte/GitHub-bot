...
const makeCommits = async (n, year, month, day) => {
  ...
  console.log(`Commit ${7-n} made with date ${year}-${month}-${day}`); // Show commit number and date
...
makeCommits(6, 2025, 2, 26); // Example: making commits with the date Jan 1, 2024
