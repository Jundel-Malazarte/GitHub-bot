...
const makeCommits = async (n, year, month, day) => {
  ...
  console.log(`Commit ${29 - n} made with date ${year}-${month}-${day}`); // Show commit number and date
...
makeCommits(28, 2024, 1, 14); // Example: making 250 commits with the date Jan 1, 2024
