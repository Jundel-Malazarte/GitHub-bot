...
const makeCommits = async (n, year, month, day) => {
  ...
  console.log(`Commit ${18 - n} made with date ${year}-${month}-${day}`); // Show commit number and date
...
makeCommits(18, 2024, 3, 15); // Example: making 250 commits with the date Jan 1, 2024
