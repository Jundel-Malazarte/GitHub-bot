...
const makeCommits = async (n, year, month, day) => {
  ...
  console.log(`Commit ${0 - n} made with date ${year}-${month}-${day}`); // Show commit number and date
...
makeCommits(35, 2024, 4, 16); // Example: making 250 commits with the date Jan 1, 2024
